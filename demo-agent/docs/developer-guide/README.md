...
This guide is for developers who want to contribute to the `demo_agent` package. It provides instructions on how to set up your development environment, run tests, and contribute to the project.
...
1.  **Clone the repository:**
    ```bash
    git clone https://gitlab.com/example/demo-agent
    cd demo-agent
    ```
